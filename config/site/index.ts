...
export const siteConfig = {
  ...
  coreValues: [
    { title: "Creativity", description: "Pushing boundaries with innovative design solutions", icon: "sparkles" },
    { title: "Integrity", description: "Honest and transparent in all our dealings", icon: "shield" },
    { title: "Quality Excellence", description: "Delivering premium craftsmanship in every project", icon: "star" },
    { title: "Customer Satisfaction", description: "Your happiness is our top priority", icon: "heart" },
    { title: "Professionalism", description: "Expert service from start to finish", icon: "briefcase" },
  ],

  // Goals & Objectives
  goals: [
    { title: "High-Quality Design", description: "Deliver high-quality interior design and furnishing services", icon: "award" },
    { title: "Client Relationships", description: "Build long-term relationships with clients", icon: "users" },
    { title: "Innovation", description: "Continuously innovate in design concepts", icon: "lightbulb" },
    { title: "Competitive Pricing", description: "Maintain competitive pricing without compromising quality", icon: "trending-up" },
  ],
  ...
  // Design Process
  designProcess: [
    { step: 1, title: "Client Consultation", description: "We begin by understanding your vision, requirements, and budget through detailed discussions." },
    { step: 2, title: "Concept Development", description: "Our designers create initial concepts and mood boards tailored to your preferences." },
    { step: 3, title: "Design Approval", description: "Present comprehensive design proposals with revisions until you're completely satisfied." },
    { step: 4, title: "Material Selection", description: "Carefully select quality materials, finishes, and furnishings that match your style." },
    { step: 5, title: "Installation & Execution", description: "Our skilled team brings the design to life with meticulous attention to detail." },
    { step: 6, title: "Final Handover", description: "Complete project delivery with quality checks and customer satisfaction assurance." },
  ],
